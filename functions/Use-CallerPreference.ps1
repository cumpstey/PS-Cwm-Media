# This is taken from Carbon: https://github.com/pshdo/Carbon/blob/develop/Carbon/Functions/Use-CallerPreference.ps1
# For some reason, it's not exported in the module.
